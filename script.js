...
function roboNextTextQuiz(){
    ...
    if(roboFlag==0){
        ...
        document.getElementById("start").innerHTML+='<button class="startButton animation" id="btnStart" onclick="startQuiz()">Start</button>'
...
function startQuiz(){
    ...
    console.log(topic);
    switch(topic){
        case "alphabetQuiz.html": document.getElementById("dispScore").style='visibility:visible'; alphabetQuiz(); 
        break;
    }//switch
}//func start
